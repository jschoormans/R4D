...
P.binparams.smoothingmethod='smooth'
P.binparams.smoothspan=25; %value for MA-filter
P.binparams.visualize =1;
P.binparams.sortingmethod='p2'  %method of sorting the gating_singal: p=phase; v=value
...
cd('/home/jschoormans/lood_storage/divi/Ima/parrec/espeper/2019_07_24_CARRgonaries')
P=checkGAParams(P);
...
P.binparams.PCAfreqband=[0.07 0.3]
P.binparams.sortingmethod='v'
P.binparams.gatingnz=[1:10]
P.binparams.gatingchans=[1:26]
...
for slice=110
    ...
    reco_cs(:,:,slice,:,:,:,:,:,:,:,:) = bart('pics -S -d5 -RT:1024:0:0.005 -i50 -t', coords, ksp_acq_t, sensbart);
